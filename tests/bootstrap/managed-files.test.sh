...
rg -Fq '"~/.config/mise/mise.lock" = { source = "~/.dotfiles/mise.lock" }' "$test_root/mise.toml"
rg -Fq '"~/.config/mise/mise.full.lock" = { source = "~/.dotfiles/mise.full.lock" }' "$test_root/mise.toml"
